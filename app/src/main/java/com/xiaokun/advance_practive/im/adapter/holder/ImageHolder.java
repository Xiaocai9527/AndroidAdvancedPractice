...
import com.xiaokun.advance_practive.im.util.GlideImageLoader;
...
public class ImageHolder extends BaseMsgHolder {
    ...
    public void bind(Message message) {
        ...
        ProgressView progressView = getView(R.id.pb);
...
//        imageView.setImageBitmap(resizedBitmap);
        int width = 1000;
        int height = 1295;
        int size = calculateSize(1000, 1295, imageView.getMinimumWidth(), imageView.getMinimumHeight());
        width = width / size;
        height = height / size;
        ...
        new GlideImageLoader(imageView, progressView).load("https://ws1.sinaimg.cn/large/0065oQSqgy1fxno2dvxusj30sf10nqcm.jpg",
                RequestOptions.bitmapTransform(new RoundedCorners(20))
                        .placeholder(R.drawable.img_place_holder)
                        .diskCacheStrategy(DiskCacheStrategy.NONE));

//        Glide.with(mContext).load(((PdImgMsgBody) message.pdMsgBody).remoteUrl)
